...
public class Banani_FlatTest {
	
	public static WebDriver driver;
	
	
	@Given("^I open buyrentbd website$")
	public void i_open_buyrentbd_website() throws Throwable {
	...
	@When("^I click on Banani flat$")
	public void i_click_on_Banani_flat() throws Throwable {
		
		
		driver.findElement(By.xpath(".//*[@id='home-properties']/div[1]/article/h4/a")).click();
	...
	@When("^verift the text$")
	public void verift_the_text() throws Throwable {
	...
	@Then("^I close website$")
	public void i_close_website() throws Throwable {
